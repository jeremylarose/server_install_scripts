...
* install example (MariaDB, Docker and Xibo CMS with default docker-compose version):
  ...
  3. wget https://raw.githubusercontent.com/jeremylarose/server_install_scripts/master/XiboCMS.sh && chmod +x XiboCMS.sh && ./XiboCMS.sh -v 2.3.6 -d cms -u cms -p 'dbpassword' -h localhost -n 3306
